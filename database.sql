...
DROP TABLE IF EXISTS `rss_posts`;
...
CREATE  TABLE IF NOT EXISTS `rss_posts` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_rss_posts_feeds1` (`feeds_id` ASC) ,
  CONSTRAINT `fk_rss_posts_feeds1`
...
CREATE  TABLE IF NOT EXISTS `user_feeds` (
  `id` INT NOT NULL ,
  `favourite` TINYINT(1) UNSIGNED NULL DEFAULT NULL ,
  `users_id` INT(11) UNSIGNED NOT NULL ,
  `feeds_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_user_feeds_users1` (`users_id` ASC) ,
  INDEX `fk_user_feeds_feeds1` (`feeds_id` ASC) ,
